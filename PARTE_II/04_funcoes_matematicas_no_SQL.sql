...
-- Adição, subtração, multiplicação e divisão:
    ...
    SELECT rental_duration + rental_rate FROM sakila.film LIMIT 10; -- Retorna uma lista de resultados da soma.
    SELECT rental_duration - rental_rate FROM sakila.film LIMIT 10; -- Retorna uma lista de resultados da subtração.
    SELECT rental_duration / rental_rate FROM sakila.film LIMIT 10; -- Retorna uma lista de resultados da divisão.
    SELECT rental_duration * rental_rate FROM sakila.film LIMIT 10; -- Retorna uma lista de resultados da multiplicação.
...
Exponenciação e raiz quadrada:
    Para cálculos de exponenciação e raiz quadradas,
    podemos utilizar as funções POW e SQRT, respectivamente.
*/
