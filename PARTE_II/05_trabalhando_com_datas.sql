...
/*
Conseguimos fazer algumas coisas legais, como, por exemplo, 
...
e a diferença de tempo entre dois horários usando o TIMEDIFF. Em ambos os casos,
...
/* 
  Outro ponto interessante é que também podemos usar CURRENT_DATE() e NOW()
  em conjunto com os comandos de manipulação de datas e tempo para encontrar
